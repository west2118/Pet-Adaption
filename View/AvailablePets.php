...
<head>
    ...
    <link rel="stylesheet" href="../Styles/AvailablePets.css">
</head>
                ...
                <div class="pet-card">
                    ...
                    <div class="pet-info">
                        <div class="pet-header">
                            ...
                            <span class="pet-type"><?php echo ucfirst(htmlspecialchars($row['petType'])); ?></span>
                        </div>
                        <div class="pet-details">
                            <p><i class="fas fa-venus-mars"></i> <strong>Breed:</strong> <span><?php echo htmlspecialchars($row['breed']); ?></span></p>
                            <p><i class="fas fa-dog"></i> <strong>Gender:</strong> <span><?php echo ucfirst(htmlspecialchars($row['gender'])); ?></span></p>
